...
ImgMaxPXSizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxPXSizeService, deps: [{ token: i1.Ng2PicaService }, { token: i2.ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
