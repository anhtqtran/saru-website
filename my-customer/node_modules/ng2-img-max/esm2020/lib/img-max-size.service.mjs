...
ImgMaxSizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxSizeService, deps: [{ token: i1.ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
