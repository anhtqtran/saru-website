...
Ng2ImgMaxService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxService, deps: [{ token: i1.ImgMaxSizeService }, { token: i2.ImgMaxPXSizeService }, { token: i3.ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
