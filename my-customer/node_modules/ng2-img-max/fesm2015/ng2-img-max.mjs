...
ImgExifService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgExifService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
ImgExifService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgExifService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgExifService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
    ...
    compressImage(file, maxSizeInMB, ignoreAlpha = false, logExecutionTime = false) {
        ...
        img.onload = () => {
            this.imageExifService.getOrientedImage(img).then(orientedImg => {
                ...
                ctx === null || ctx === void 0 ? void 0 : ctx.drawImage(orientedImg, 0, 0);
                let imageData = ctx === null || ctx === void 0 ? void 0 : ctx.getImageData(0, 0, orientedImg.width, orientedImg.height);
...
ImgMaxSizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxSizeService, deps: [{ token: ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
ImgMaxSizeService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxSizeService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxSizeService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
Ng2PicaService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2PicaService, deps: [{ token: ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ImgMaxPXSizeService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxPXSizeService, deps: [{ token: Ng2PicaService }, { token: ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
ImgMaxPXSizeService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxPXSizeService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ImgMaxPXSizeService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
Ng2ImgMaxService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxService, deps: [{ token: ImgMaxSizeService }, { token: ImgMaxPXSizeService }, { token: ImgExifService }], target: i0.ɵɵFactoryTarget.Injectable });
Ng2ImgMaxService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
Ng2ImgMaxModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
Ng2ImgMaxModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxModule });
Ng2ImgMaxModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxModule, providers: [
        Ng2PicaService,
        ImgMaxPXSizeService,
        ImgMaxSizeService,
        ImgExifService,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: Ng2ImgMaxModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        Ng2PicaService,
