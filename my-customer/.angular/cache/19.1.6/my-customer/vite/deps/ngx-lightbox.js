import {
  DomSanitizer
} from "./chunk-CDDAMJPU.js";
import {
  HttpClient,
  HttpParams
} from "./chunk-MFSDPEHM.js";
import {
  DOCUMENT
} from "./chunk-ATXKS7HD.js";
import {
  ApplicationRef,
  Component,
...
FileSaverDirective.ɵfac = function FileSaverDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || FileSaverDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FileSaverService), ɵɵdirectiveInject(HttpClient));
};
...
LightboxEvent.ɵprov = ɵɵdefineInjectable({
  token: LightboxEvent,
...
LightboxWindowRef.ɵprov = ɵɵdefineInjectable({
...
LightboxComponent.ɵcmp = ɵɵdefineComponent({
...
LightboxConfig.ɵprov = ɵɵdefineInjectable({
...
LightboxOverlayComponent.ɵcmp = ɵɵdefineComponent({
...
Lightbox.ɵprov = ɵɵdefineInjectable({
  token: Lightbox,
...
LightboxModule.ɵmod = ɵɵdefineNgModule({
  type: LightboxModule
});
LightboxModule.ɵinj = ɵɵdefineInjector({
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(LightboxModule, {
    declarations: [LightboxOverlayComponent, LightboxComponent],
    imports: [FileSaverModule]
  });
})();
