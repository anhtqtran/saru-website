...
export class OrderService {
  private apiUrl = 'http://localhost:3000/orders'; // 🔹 Thay đổi nếu cần
  ...
  // }
  // addBlog(model: Order){
  //   return this.http.post('http://localhost:3000/orders', model);
  // }
  // updateBlog(id: string, model: Order){
  //   return this.http.put('http://localhost:3000/orders/'+id, model);
  // }
